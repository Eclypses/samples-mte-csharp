...
namespace PackageCSharpECDHFW.Asn1
{
    ...
    public static partial class AsnDecoder
    {
            ...
            Asn1Tag? expectedTag = null)
        {
            ...
            if (rented != null)
            {
                Helpers.Return(rented, contents.Length);
            }
            ...
            out int bytesConsumed)
        {
            ...
            if (actualTag.IsConstructed)
            {
                ...
                {
                    throw new AsnContentException("ContentException_InvalidUnderDer_TryBerOrCer");
                }
            ...
            {
                throw new AsnContentException("ContentException_InvalidUnderCer_TryBerOrDer");
            }
            ...
            bool isIndefinite)
        {
            ...
            {
                throw new AsnContentException("ContentException_InvalidUnderCerOrDer_TryBer");
            }
