...
namespace PackageCSharpECDHFW.Asn1
{
    ...
    public sealed partial class AsnWriter
    {
        ...
        private void WriteBitStringCore(Asn1Tag tag, ReadOnlySpan<byte> bitString, int unusedBitCount)
        {
            ...
            {
                throw new ArgumentException("Argument_UnusedBitCountMustBeZero", nameof(unusedBitCount));
            }
            ...
            {
                throw new ArgumentException("Argument_UnusedBitWasSet", nameof(unusedBitCount));
            }
