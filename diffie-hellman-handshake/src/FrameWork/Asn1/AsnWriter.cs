...
namespace PackageCSharpECDHFW.Asn1
{
    ...
    public sealed partial class AsnWriter
    {
        ...
        public int GetEncodedLength()
        {
            ...
            {
                throw new InvalidOperationException("AsnWriter_EncodeUnbalancedStack");
            }
        ...
        public void WriteEncodedValue(ReadOnlySpan<byte> value)
        {
            ...
            if (!read || consumed != value.Length)
            {
                throw new ArgumentException(
                    "Argument_WriteEncodedValue_OneValueAtATime",
                    nameof(value));
            }
        ...
        private void PopTag(Asn1Tag tag, UniversalTagNumber tagType, bool sortContents = false)
        {
            ...
            {
                throw new InvalidOperationException("AsnWriter_PopWrongTag");
            }
