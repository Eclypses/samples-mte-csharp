    ...
    public sealed partial class AsnWriter
    {
        ...
        private void WriteObjectIdentifierCore(Asn1Tag tag, ReadOnlySpan<char> oidValue)
        {
            ...
            if (oidValue.Length < 3)
                throw new ArgumentException("Argument_InvalidOidValue, nameof(oidValue)");
            if (oidValue[1] != '.')
                throw new ArgumentException("Argument_InvalidOidValue, nameof(oidValue)");
            ...
            byte[] tmp = Helpers.Rent(oidValue.Length / 2);
            int tmpOffset = 0;
            ...
            try
            {
                int firstComponent = oidValue[0] switch
                {
                    ...
                    '1' => 1,
                    '2' => 2,
                    _ => throw new ArgumentException("Argument_InvalidOidValue, nameof(oidValue)"),
                };
        ...
        private static int AtoI(char c)
        {
            ...
            throw new ArgumentException("Argument_InvalidOidValue", "oidValue");
        }
